...
from pygezet import gezet, CMD_HELP, DEVS
...
GCAST_BLACKLIST = [
    ...
    -1001861034056,  # GzSupportGroup
]


@gezet(["fgcast", "fw_cast"])
async def gcast_cmd(client: Client, message: Message):
    if message.reply_to_message:
        gezetXD = await message.reply("<code>Started global broadcast...</code>")
    else:
